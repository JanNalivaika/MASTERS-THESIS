...
\include{source/Acknowledgment}%%% ADD ME !!!!!!!!!!!!!!!!!!!!
%
% Task formulation
% ----------------
\include{source/task}%% ADD ME !!!!!!!!!!!!!!!!!!!!
%
% Abstract
% --------
\include{source/abstract}%% ADD ME !!!!!!!!!!!!!!!!!!!!
%
% Content
% -------
\IWBstudentthesisPrintTableOfContents%%% ADD ME !!!!!!!!!!!!!!!!!!!!
%
% List of Abbreviations
% ---------------------
\printnoidxglossary[type=acronym,sort=standard,title={\IWBlangAcronyms}]% ADD ME !!!!!!!!!!!!!!!!!!!!
%
% Mainmatter
% ----------
\mainmatter%
%\include{source/latex_tutorial}%
\include{source/chapter01}%% ADD ME !!!!!!!!!!!!!!!!!!!!
\include{source/chapter02}%% ADD ME !!!!!!!!!!!!!!!!!!!!
\include{source/chapter03}%% ADD ME !!!!!!!!!!!!!!!!!!!!
\include{source/chapter04}%% ADD ME !!!!!!!!!!!!!!!!!!!!
\include{source/chapter05}%% ADD ME !!!!!!!!!!!!!!!!!!!!
%
% Appendix
% --------
%\appendix%
...
% References
% ----------
\printbibliography[heading=bibintoc, title={\IWBlangBibliography}]% % ADD ME !!!!!!!!!!!!!!!!!!!!
