...
The acceleration in joint 1 and the combined total travel in the joints display a smooth oscillating curve.
...
Figure \ref{GS4} illustrates the combined local scores in the form of the global score. The highest global score is 71.9, which is achieved by setting the C-axis to -115°. %Notably, in the range from -70° to 40°, a very smooth curve is observed.
