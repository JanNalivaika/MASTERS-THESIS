...
\begin{figure}[H]
	\centerline{\includegraphics[scale=.55]{figures/5ax.png}}
...
\newpage
Figure \ref{fig:CMT2} shows the clearly distinct parts in a \acrshort{CMT} cycle. At first an electric arc is formed and melts the wire (see Figure \ref{fig:CMT2}a). After a short circuit is established (see Figure \ref{fig:CMT2}b) the wire retracts and detaches from the molten droplet (see Figure \ref{fig:CMT2}c). After that the cycle restarts (see Figure \ref{fig:CMT2}d).
