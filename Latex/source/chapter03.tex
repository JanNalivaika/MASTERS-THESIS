...
\begin{figure}[H]
	\centerline{\includegraphics[width=1\textwidth]{figures/Flow.png}}
...
\begin{figure}[H]
	\centerline{\includegraphics[width=1\textwidth]{figures/localscore.png}}
...
\begin{figure}[H]
	\centerline{\includegraphics[width=0.9\textwidth]{figures/lowstd.png}}
	\caption{Variation with low standard deviation}
	\label{lowstd}
\end{figure}

\begin{figure}[H]
	\centerline{\includegraphics[width=0.9\textwidth]{figures/highstd.png}}
